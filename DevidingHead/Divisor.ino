...
#define GearRatio3top  60       //   define this value to be 1.  GearRatio1 is the default
...
#define motorSTEPpin   9    // output signal to step the motor
#define motorDIRpin    8    // output siagnal to set direction
#define motorENABLEpin 10   // output pin to power up the motor
...
*/
  if (key_in > 1000 && (key_in < 600)) return NO_KEY;    
  if (key_in > 900 && (key_in < 1000)) return RIGHT_KEY;     //VD    - entre 900 e 1000
  if (key_in > 800 && (key_in < 900))  return UP_KEY;        //VM    - entre 801 e 900
  if (key_in > 750 && (key_in < 800))  return DOWN_KEY;      //VM    - entre 751 e 800  
  if (key_in > 700 && (key_in < 750))  return LEFT_KEY;      //verde - entre 701 e 750 
  if (key_in > 650 && (key_in < 700))  return SELECT_KEY;    //Azul  - entre 650 e 700
